...
test("required recovery, accessibility, and preview language is present", async () => {
  ...
  for (const phrase of ["Drafts", "Approximate preview", "Reload latest", "Save as new project", "media not copied", "Reconnecting", "magic link", "Google", "Pexels", "Cancel render", "Download preview", "Accurate preview failed", "Retry", "Settings", "Sign out", "Waiting for media inspection", "Media is still inspecting"]) assert.match(source, new RegExp(phrase));
});
