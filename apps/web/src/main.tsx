...
export function App() {
  ...
  function showFalLock() {
    ...
    setFeatureLock(falCredential?.connected
      ...
      : { title: "FAL generation is locked", message: "Connect your FAL API key in Settings. AI stills, animation, and footage analysis unlock in the storyboard after you connect.", action: "settings" });
  }
