...
Open `http://127.0.0.1:8080`. The container prints an operator token on first
boot — use it at `/studio`. Details: [docs/runbooks/self-host.md](docs/runbooks/self-host.md).
